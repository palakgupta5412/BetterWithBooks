...
const Navbar = () => {
  ...
  return (
    <nav  className="text-[#D8CFC4] stick font-gravitas text-lg w-[60%] h-14 mt-4 flex justify-center items-center gap-10 backdrop-blur-md rounded-full mx-auto bg-white/10 overflow-hidden">
